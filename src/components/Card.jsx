...
const Card = ({ data }) => {
  ...
  return (
    <div className="flex flex-col w-[80%] md:w-[30%] lg:w-[20%] min-w-[20%] bg-neutral-200 dark:bg-neutral-900 rounded-lg gap-1 transition-transform duration-300 hover:scale-105 hover:shadow-lg">
      ...
      <div className="p-2">
        ...
        <p className="text-left text-gray-600 dark:text-gray-400 truncate text-sm">{data.description}</p>
        <Link 
