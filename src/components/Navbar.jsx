...
const Navbar = () => {
  ...
  return (
    <nav className="bg-neutral-900 shadow-lg sticky top-0 z-50">
        ...
        <div className="flex justify-between h-12">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-white">Price Slasher</span>
            </Link>
            <div className="hidden md:flex ml-10 space-x-8">
              <Link to="/giveaways" className="text-gray-200 hover:text-white px-3 py-2 rounded-md text-md font-medium transition-colors">
                Giveaways
              </Link>
              <Link to="/about" className="text-gray-200 hover:text-white px-3 py-2 rounded-md text-md font-medium transition-colors">
                About
              </Link>
              <Link to="https://nullyarcv.vercel.app/" className="text-gray-200 hover:text-white px-3 py-2 rounded-md text-md font-medium transition-colors">
                Contacts
              </Link>
            </div>
          </div>
          <div className="hidden md:flex items-center space-x-4">
            {isLoggedIn ? (
              ...
              <>
                <Link
                  to="/login"
                  className="text-gray-200 hover:text-white px-3 py-2 rounded-md text-md font-medium transition-colors"
                >
                  Log In
                </Link>
                <Link
